...
export const EN = {
  ...
  "khata.badge": "Daily book",
  "khata.title": "Khata",
  "khata.subtitle": "Write down what you sold and what you spent. It stays on this phone.",
  "khata.export": "Export the whole book",
  "khata.today": "Today",
  "khata.inOut": "{inAmt} in · {outAmt} out",
  "khata.month": "This month",
  "khata.overDays": "over {n} recorded days",
  "khata.moneyIn": "Money in, this month",
  "khata.moneyOut": "Money out, this month",
  "khata.entries": "{n} entries",
  "khata.costOfTrade": "what the trade cost you",
  "khata.instalmentPerMonth": "Your instalment of {quarter} every quarter is {month} a month.",
  "khata.monthUp": "This month you are up {amount}.",
  "khata.monthDown": "This month you are down {amount}.",
  "khata.tooFewDays": "{n} of at least {min} days recorded. A verdict built on a couple of entries would be noise dressed up as a finding, so there is none yet.",
  "khata.headroom": "{amount} a month left over after the instalment.",
  "khata.shortfall": "{amount} a month short. This is the gap that sends a sanctioned borrower to a moneylender.",
  "khata.basedOn": "Based on {n} recorded days this month.",
  "khata.schedule": "The repayment schedule",
  "khata.addEntry": "Add an entry",
  "khata.addHint": "Money in is a sale. Money out is an expense.",
  "khata.inOutGroup": "Money in or money out",
  "khata.in": "Money in",
  "khata.out": "Money out",
  "khata.amount": "Amount (₹)",
  "khata.day": "Day",
  "khata.note": "Note",
  "khata.notePlaceholder": "milk, feed, transport…",
  "khata.save": "Write it down",
  "khata.emptyTitle": "The book is empty",
  "khata.sale": "Sale",
  "khata.expense": "Expense",
  "khata.deleteEntry": "Delete this entry",
  "khata.footer": "Your book is kept in this browser only. Nothing is uploaded, and nobody else can see it — which also means clearing your browser data clears the book, so export it now and then.",
  "market.badge": "Market scan",
  "market.title": "Who else is nearby",
  "market.subtitle": "A live look at what is already trading around you, to sit alongside the feasibility report's published figures.",
  "market.searchAround": "Search around",
  "market.howToRead": "How to read this.",
  "market.howBody1": "Google's map of a village is not a business register. A shop appears on it because somebody added it — an owner, a customer, or a survey — and in most of rural India nobody has. So a low number here means low coverage at least as often as it means low competition.",
  "market.howBody2": "It is still worth having, in one direction: if Google already knows about four kirana shops within two kilometres, there are at least four. A floor is evidence. A ceiling this is not.",
  "market.published": "The published figures",
  "mkt.title": "B2B Marketplace",
  "mkt.subtitle": "Write down exactly what you are buying or selling, then send it to a trader, cooperative or FPO on WhatsApp.",
  "mkt.write": "Write a requirement",
  "mkt.close": "Close",
  "mkt.yourRequirement": "Your requirement",
  "mkt.sideGroup": "Are you selling or buying?",
  "mkt.selling": "I am selling",
  "mkt.buying": "I am buying",
  "mkt.goods": "Goods",
  "mkt.goodsPlaceholder": "A2 cow milk, hand-woven baskets, organic jaggery…",
  "mkt.quantity": "Quantity",
  "mkt.unit": "Unit",
  "mkt.priceFrom": "Price from (₹)",
  "mkt.priceTo": "Price to (₹)",
  "mkt.optional": "Optional",
  "mkt.availableUntil": "Available until",
  "mkt.neededBy": "Needed by",
  "mkt.notes": "Notes",
  "mkt.notesPlaceholder": "Grade, packaging, delivery, payment terms — anything a buyer would ask.",
  "mkt.blankPriceOk": "Leaving both price fields blank is fine — the requirement will read “Negotiable”.",
  "mkt.locationWillRead": "Location will read {loc}.",
  "mkt.save": "Save requirement",
  "mkt.cancel": "Cancel",
  "mkt.yourRequirements": "Your requirements",
  "mkt.exportCsv": "Export CSV",
  "mkt.sellingChip": "Selling",
  "mkt.wantedChip": "Wanted",
  "mkt.deleteRequirement": "Delete this requirement",
  "mkt.copy": "Copy",
  "mkt.copied": "Copied",
  "mkt.whatsapp": "WhatsApp",
  "mkt.boardTitle": "What a live board would look like",
  "mkt.boardNote": "These three are examples, not real listings — there is no counterparty behind them, so offering is disabled. They show the shape of the board once a deployment has buyers on it.",
  "mkt.example": "Example",
  "mkt.offers": "Offers",
  "mkt.offeringLater": "Offering opens with a deployment",
  "unit.kg": "kg",
  ...
  "unit.bags": "bags",
  "unit.tonnes": "tonnes",
  "req.err.product": "Say what the goods are.",
  "req.err.productShort": "A little more detail — a buyer has to recognise it.",
  "req.err.quantity": "How much? A quantity of zero is not a requirement.",
  "req.err.money": "Not a rupee figure.",
  "req.err.range": "The upper end is below the lower end.",
  "req.err.date": "Not a date.",
  "req.err.notes": "Keep it under {max} characters.",
  "comm.badge": "Community Hub",
  "comm.headingKnown": "{category} entrepreneurs — {district}",
  "comm.introKnown": "Write down what you are working on. Notes are kept on this device.",
  "comm.introUnknown": "Finish onboarding and this becomes your own block’s hub.",
  "comm.exampleGroups": "Example groups",
  "comm.joiningLater": "Joining is not built yet",
  "comm.whoHelps": "Who actually helps",
  "comm.whoHelpsBody": "Real institutions in your district — RSETIs, KVKs, District Industries Centres and NABARD offices — with their public listings.",
  "comm.openDirectory": "Open the directory",
  "comm.composerPlaceholder": "Share an update, ask a question, or note a requirement…",
  "comm.writePost": "Write a post",
  "comm.kindGroup": "What kind of post is this?",
  "comm.kind.update": "Update",
  "comm.kind.question": "Question",
  "comm.kind.requirement": "Requirement",
  "comm.post": "Post",
  "comm.you": "You",
  "comm.savedHere": "Saved on this device",
  "comm.deletePost": "Delete this post",
  "comm.example": "Example",
  "comm.footer": "Posts you write are kept in this browser only. There is no account and no server behind this screen yet, so nobody else can see them — the three examples above show what a deployed feed would carry.",
  "comm.marketplace": "Marketplace",
  "comm.marketplaceBody": "Compose a buying or selling requirement precisely enough that a trader can act on it, then send it on WhatsApp or export it.",
  "demo.notice": "Demo session — Ramkali's two-cow dairy in Ghatigaon. Every figure is computed by the same engine from these entries; clear it whenever you like.",
  "demo.clear": "Clear demo",
  "demo.load": "Load a demo session",
  "mkt.budget": "Budget:",
  "mkt.exampleBuyer": "Example buyer",
  "mkt.negotiable": "Negotiable",
  "mkt.ex1.title": "50 litres of A2 milk daily, six-month contract",
  "mkt.ex1.deadline": "2 days left",
  "mkt.ex2.title": "Bulk order: 500 hand-woven baskets for Diwali",
  "mkt.ex2.deadline": "12 hours left",
  "mkt.ex3.title": "Organic jaggery supplier wanted, 100 kg a week",
  "mkt.ex3.deadline": "5 days left",
  "mkt.ex2.budget": "₹1.5 lakh total",
  "cp.buyers": "Who might buy this",
  "cp.suppliers": "Who might supply this",
  "cp.found": "{n} within {km} km · {c} with a phone number",
  "cp.searchAgain": "Search again",
  "cp.none": "Nothing matching {queries} is on Google’s map within {km} km. In a rural block that is as likely to mean nobody has listed them as that nobody is there — ask at the mandi.",
  "cp.call": "Call",
  "cp.send": "Send requirement",
  "cp.noPhone": "No phone number listed",
  "cp.directions": "Directions",
  "cp.website": "Website",
  "cp.footer": "{attribution}. These are businesses already trading nearby — they are not users of this app and have not seen your requirement. Searched: {queries}.",
  "cp.notConfigured": "Business search is not configured on this deployment.",
  "cp.tooMany": "Too many searches. Wait a minute.",
  "cp.failed": "The lookup failed.",
  "cp.unreachable": "Could not reach the server.",
} as const;
