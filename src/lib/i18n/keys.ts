...
export const EN = {
  ...
  // ── scheme eligibility ────────────────────────────────────────────────────
  "elig.title": "Which schemes you match",
  "elig.subtitle":
    "Fourteen central schemes, checked against their published criteria. This is not a decision — the agency decides on a filed application.",
  "elig.aboutYou": "A few things about you",
  "elig.aboutYouHint": "Only what a scheme actually asks. Leave anything blank and it stays an open question rather than a no.",
  "elig.category": "Social category (choose any that apply)",
  "elig.cat.sc": "Scheduled Caste",
  "elig.cat.st": "Scheduled Tribe",
  "elig.cat.obc": "OBC",
  "elig.cat.minority": "Minority",
  "elig.cat.pwd": "Person with disability",
  "elig.cat.safai": "Safai karamchari",
  "elig.cat.general": "General",
  "elig.income": "Annual family income",
  "elig.gender": "Gender",
  "elig.gender.female": "Woman",
  "elig.gender.male": "Man",
  "elig.gender.other": "Other",
  "elig.streetVendor": "Are you a street vendor?",
  "elig.shg": "Are you in a self-help group?",
  "elig.yes": "Yes",
  "elig.no": "No",
  "elig.countMeets": "{n} match the criteria",
  "elig.countNeedsInfo": "{n} need more information",
  "elig.countRuledOut": "{n} ruled out",
  "elig.verdict.meets": "Meets the published criteria",
  "elig.verdict.needs-info": "Need more information",
  "elig.verdict.does-not-meet": "Does not meet",
  "elig.ruledOutBy": "Ruled out by",
  "elig.stillNeeded": "Still needed to decide",
  "elig.amount": "Amount:",
  "elig.benefit": "Benefit:",
  "elig.openScheme": "Open the scheme page",


  // ── dashboard ──
  "dash.badge": "Your enterprise",
  "dash.title": "Dashboard",
  "dash.introIncomplete": "Answer three questions and this becomes your own plan, in your own block.",
  "dash.share": "Shareable summary",
  "dash.emptyTitle": "Nothing to show yet — and nothing invented to fill the gap",
  "dash.emptyBody": "Where you are, what you can put in, and what you want to do. Every figure on this dashboard is computed from those three answers, so until they exist there is nothing honest to display.",
  "dash.emptyCta": "Answer the three questions",
  "dash.emptySecondary": "Browse trades first",
  "dash.next": "Next",
  "dash.projectCost": "Project cost",
  "dash.loan": "Loan you would take",
  "dash.perQuarter": "Every quarter",
  "dash.yourMoney": "Your own money",
  "dash.marginRequired": "margin required: {amount}",
  "dash.rateOverYears": "{rate}% over {years} years",
  "dash.costedFrom": "costed from the activity",
  "dash.noPlanBody": "The engine could not size a project from these answers yet — usually because the margin is too small for any activity in the catalogue.",
  "dash.noPlanLink": "Try the calculator",
  "dash.noPlanTail": "to see where the boundary falls.",
  "dash.gapTitle": "Repayment starts {n} months before this earns",
  "dash.noGapTitle": "Repayment starts after this earns",
  "dash.instalmentFalls": "The first instalment of {amount} falls in month {month}",
  "dash.earnsFromStart": ", and this activity earns from the start.",
  "dash.needsMonths": ", and this activity needs {n} months before it earns anything.",
  "dash.projection": "If it were disbursed today, that would be {date}. No loan has been applied for — this is a projection.",
  "dash.seeSchedule": "See the full schedule",
  "dash.readyTitle": "How ready you are",
  "dash.readyCount": "{done} of {total}",
  "dash.schemesTitle": "Government schemes",
  "dash.youMeet": "You meet",
  "dash.needAnswers": "Need answers",
  "dash.ruledOut": "Ruled out",
  "dash.openQuestions": "Answering these would settle the most",
  "dash.checkSchemes": "Check every scheme",
  "dash.pickTrade": "Pick a trade and this fills in.",
  "dash.yourNotes": "Your notes",
  "dash.yourRequirements": "Your requirements",
  "dash.noteCount": "{n} written",
  "dash.reqCount": "{n} composed",
  "dash.nothingWritten": "Nothing written yet.",
  "dash.nothingComposed": "Nothing composed yet.",
  "dash.openCommunity": "Open community",
  "dash.openMarketplace": "Open marketplace",
  "dash.everythingElse": "Everything else",

  // ── readiness checklist ──
  "ready.location": "Where you are",
  "ready.location.hint": "District and block decide which offices and schemes apply.",
  "ready.capital": "What you can put in",
  "ready.capital.hint": "Your own margin money sets the size of everything else.",
  "ready.category": "What you want to do",
  "ready.category.hint": "The trade decides the unit cost, the gestation and the scheme tier.",
  "ready.report": "Feasibility report read",
  "ready.report.hint": "The competition, demand and cost picture for your block.",
  "ready.plan": "Repayment plan seen",
  "ready.plan.hint": "What you would owe, every quarter, and when it starts.",
  "ready.schemes": "Scheme eligibility checked",
  "ready.schemes.hint": "Which government schemes you can actually apply to.",
  "ready.share": "Summary ready to share",
  "ready.share.hint": "The one page a bank or an NGO would ask you for.",

  // ── the next step ──
  "next.onboard": "Finish the three questions",
  "next.onboard.detail": "Where you are, what you can put in, and what you want to do. Everything else is computed from those.",
  "next.onboard.cta": "Answer them",
  "next.done": "Take it to somebody",
  "next.done.detail": "Your summary page is the one document a bank branch, an RSETI or an NGO will ask you for. Print it or send it.",
  "next.done.cta": "Open the summary",
  "next.open": "Open",

  // ── quick links ──
  "link.discover": "Discover a trade",
  "link.discover.body": "What your block can actually support, and what it cannot.",
  "link.report": "Feasibility report",
  "link.report.body": "Competition, demand and cost, each with its source.",
  "link.calculator": "Calculator",
  "link.calculator.body": "Every rupee of the schedule, traceable by hand.",
  "link.emi": "Loan tracker",
  "link.emi.body": "A repayment schedule, quarter by quarter.",
  "link.mentors": "Who helps you",
  "link.mentors.body": "RSETIs, KVKs, District Industries Centres — real offices.",
  "link.profile": "Your profile",
  "link.profile.body": "Built from your own answers. Nothing else on it.",
  "link.officer": "Officer console",
  "link.officer.body": "The same rules engine, from a sanctioning officer's side.",
  "link.investor": "Funding view",
  "link.investor.body": "The same queue, ranked by what it would achieve.",
  "link.schemes": "Scheme eligibility",
  "link.schemes.body": "Fourteen schemes, with the criteria you meet and miss.",

  // ── profile page ──
  "prof.shareCard": "Shareable summary",
  "prof.shareCardBody": "The one page a bank or NGO asks for.",
  "prof.notes": "{n} written by you",
  "prof.reqs": "{n} composed by you",
  "prof.whereTitle": "Where this record can go",
  "prof.whereBody1": "Everything on this page is either something you typed or something the engine computed from it. It carries no score, no rating and no verification badge, because none of those exist — there is no KYC step, no application and no lender behind this product.",
  "prof.whereBody2": "What it is good for is the conversation: the summary page prints the project cost, the scheme, the schedule and the solvency verdict with their sources attached, which is what a branch manager or an RSETI counsellor will ask you to produce.",
  "prof.resetTitle": "Start over",
  "prof.resetBody": "Clears your answers, your notes and your requirements from this browser. Nothing is stored anywhere else, so nothing else has to be deleted.",
  "prof.resetConfirm": "Yes, clear everything",
  "prof.cancel": "Cancel",
