...
const dictionary = {
  en: {
    ...
    // JourneyStepper
        "step.schemes": "Schemes",
    "nav.khata": "Khata",
        "hero.problem.title": "What a borrower walks in with",
    "hero.problem.1": "Which scheme am I even eligible for?",
    "hero.problem.2": "How much will the instalment be?",
    "hero.problem.3": "The first payment lands before I earn anything",
    "hero.problem.4": "Is there already a shop like mine next door?",
    "hero.problem.5": "Who will actually buy what I make?",
    "hero.outcome.title": "What they walk out with",
    "hero.outcome.1": "14 schemes checked against your own answers",
    "hero.outcome.2": "The exact quarterly instalment, traceable by hand",
    "hero.outcome.3": "A warning when repayment beats first income",
    "hero.outcome.4": "Shops already trading within 5 km, on a map",
    "hero.outcome.5": "Real buyers nearby, with phone numbers",
  ...
  hi: {
    ...
    // JourneyStepper
        "step.schemes": "योजनाएँ",
    "nav.khata": "खाता",
        "hero.problem.title": "कर्ज़ लेने वाला क्या लेकर आता है",
    "hero.problem.1": "मैं किस योजना के लायक़ हूँ?",
    "hero.problem.2": "किस्त कितने की बनेगी?",
    "hero.problem.3": "कमाई शुरू होने से पहले ही पहली किस्त आ जाती है",
    "hero.problem.4": "क्या मेरे जैसी दुकान पहले से पास में है?",
    "hero.problem.5": "मेरा माल आख़िर ख़रीदेगा कौन?",
    "hero.outcome.title": "क्या लेकर जाता है",
    "hero.outcome.1": "आपके अपने जवाबों पर 14 योजनाएँ जाँची गईं",
    "hero.outcome.2": "हर तिमाही की सही किस्त, हाथ से जाँचने लायक़",
    "hero.outcome.3": "कमाई से पहले किस्त आ रही हो तो चेतावनी",
    "hero.outcome.4": "5 किमी के अंदर पहले से चल रही दुकानें, नक़्शे पर",
    "hero.outcome.5": "आस-पास असली ख़रीदार, फ़ोन नंबर समेत",
    "step.discover": "खोजें",
  ...
  hinglish: {
    ...
    // JourneyStepper
        "step.schemes": "Yojanayein",
    "nav.khata": "Khata",
        "hero.problem.title": "Karz lene wala kya lekar aata hai",
    "hero.problem.1": "Main kis yojana ke layak hoon?",
    "hero.problem.2": "Kist kitne ki banegi?",
    "hero.problem.3": "Kamai shuru hone se pehle hi pehli kist aa jaati hai",
    "hero.problem.4": "Kya mere jaisi dukaan pehle se paas mein hai?",
    "hero.problem.5": "Mera maal aakhir kharidega kaun?",
    "hero.outcome.title": "Kya lekar jaata hai",
    "hero.outcome.1": "Aapke apne jawabon par 14 yojanayein jaanchi gayin",
    "hero.outcome.2": "Har timahi ki sahi kist, haath se jaanchne layak",
    "hero.outcome.3": "Kamai se pehle kist aa rahi ho to chetavni",
    "hero.outcome.4": "5 km ke andar pehle se chal rahi dukanein, naqshe par",
    "hero.outcome.5": "Aas-paas asli kharidar, phone number samet",
